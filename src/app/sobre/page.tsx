...
export default function Sobre() {
  return (
    <>
      <div className="max-w-md mx-auto my-8 p-6 bg-white shadow-lg rounded-lg text-xl">
        ...
        <ul className="list-disc list-inside text-gray-700 mb-6">
          ...
          <li>
            <span className="font-bold">Entrega Rápida:</span> Respeitamos seus
            prazos.
          </li>
        </ul>
        <p className="text-gray-700 text-center mb-6">
          🚀 <span className="font-bold">Não perca tempo!</span> Deixe a Fequer
          Transportes cuidar do transporte da sua carga. Entre em contato
          conosco hoje mesmo e descubra como podemos ajudar a impulsionar o seu
          negócio!
        </p>
      </div>
