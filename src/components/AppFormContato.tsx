...
export const AppFormContato = () => {
  const [agreed, setAgreed] = useState(false);

  return (
    <div className="isolate bg-[#005fa4] px-6 py-6 lg:py-24 sm:py-32 lg:px-8">
      <div
        className="absolute inset-x-0 top-[-10rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]"
        aria-hidden="true"
      >
        <div
          className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-[#005fa4] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
      ...
      <form
        action="#"
        method="POST"
        className="mx-auto mt-6 lg:mt-16 max-w-xl sm:mt-20"
      >
      ...
      <div className="text-center mb-6">
        <p className="text-gray-700 mb-2">
          ...
          <a
            href="mailto:rogerio.fequer@ig.com"
            className="text-blue-500 hover:underline"
          >
            rogerio.fequer@ig.com
          </a>
        </p>
        <p className="text-gray-700 mb-2">
        ...
        <p className="text-gray-700">
          📍 <span className="font-bold">Endereço:</span> Rua Drava, 610, São
          Paulo, Brazil
        </p>
      </div>
      <div className="text-center">
        <a
          href="mailto:rogerio.fequer@ig.com"
          className="inline-block px-5 py-2.5 bg-blue-700 text-white font-medium rounded-lg text-sm hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
